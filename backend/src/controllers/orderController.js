...
//         success: false,
//         message:
//           "Invalid delivery option. Allowed: express, one_day, normal, self_collection",
//       });
//     }
...
//      * zohoResult.customer.contact_id
//      *
//      * because the service does not return
//      * a "customer" object.
//      */
...
//       zohoResult.invoice.customer_id;
...
const createOrder = async (req, res) => {
  try {
    ...
    let finalExpectedDeliveryDate = null;

    if (expectedDeliveryDate) {

      const parsedExpectedDeliveryDate =
        new Date(
          `${expectedDeliveryDate}T00:00:00`
        );
