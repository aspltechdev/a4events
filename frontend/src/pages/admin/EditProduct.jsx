...
//       "Fresh Items - Seasonal Fruits & Flowers"
//     ) {
//       return "Fruits / Flowers";
//     }

//     if (formData.category === "Millet Mix & Soups") {
//       return "Ingredients";
//     }
...
//     if (formData.category === "Organics") {
//       return "Varieties / Types";
//     }
...
//             <p>
//               Update product details, pricing, discounts and images
//             </p>
//           </div>
//         </div>
...
//                     <div
//                       key={index}
//                       className="aep-ingredient-card"
//                     >

//                       <div className="aep-ingredient-card-header">

//                         <span className="aep-ingredient-number">
//                           #{index + 1}
//                         </span>
...
//                             >
//                               <path
//                                 d="M10 3.5L3.5 10M3.5 3.5l6.5 6.5"
//                                 stroke="currentColor"
//                                 strokeWidth="1.5"
//                                 strokeLinecap="round"
//                               />
...
//                               formData.category ===
//                               "Fresh Items - Seasonal Fruits & Flowers"
//                                 ? "e.g. Mango, Rose, Jasmine"
//                                 : "e.g. Ragi, Jowar, Bajra"
//                             }
//                             value={item.title}
//                             onChange={(e) =>
//                               updateIngredient(
...
//   onClick={() => {
//     setFile(null);
//     setPreview(null); // Clear preview completely
//   }}
// >
//   <svg
//     width="16"
...
// </button>
//                       {file && (
//                         <span className="aep-preview-badge">
//                           New
//                         </span>
//                       )}
...
//                       <span className="aep-upload-hint">
...
//                   <span className="aep-checkbox-text">
//                     Featured Product
//                   </span>
...
function EditProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Upload product image if a new file is selected
      if (file) {
        const uploadData = new FormData();
        ...
        imageUrl = uploadResponse.data.imageUrl;
      } else if (file === null && preview === null) {
        // If file is null and preview is null, the user wants to remove the image
        imageUrl = "";
      }
      // If file is null but preview exists, keep the existing image (formData.image)
