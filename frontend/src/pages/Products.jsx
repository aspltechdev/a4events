...
//   // =====================================================
//   // TOUCH HANDLERS FOR MARQUEE PAUSE
//   // =====================================================
...
//     // Optionally pause while swiping
//     setIsPaused(true);
//   };
...
//     // Small delay before resuming to prevent accidental resume
//     setTimeout(() => {
//       // Only resume if not hovering (for desktop)
//       setIsPaused(false);
//     }, 500);
//   };

//   // Clean up touch listeners on unmount
//   useEffect(() => {
//     return () => {
//       setIsPaused(false);
//     };
...
function Products() {
  ...
  const marqueeStageRef = useRef(null);
  ...
  // =====================================================
  // MARQUEE DRAG SCROLL - MOBILE & DESKTOP
  // =====================================================

  const handleMouseDown = (e) => {
    if (!marqueeStageRef.current) return;
    
    // Don't start drag if clicking on interactive elements
    if (e.target.closest('a') || e.target.closest('button')) return;
    
    setIsDragging(true);
    setStartX(e.pageX - marqueeStageRef.current.offsetLeft);
    setScrollLeft(marqueeStageRef.current.scrollLeft);
    setIsPaused(true);
  ...
  const handleMouseMove = (e) => {
    if (!isDragging || !marqueeStageRef.current) return;
    
    e.preventDefault();
    const x = e.pageX - marqueeStageRef.current.offsetLeft;
    const walk = (x - startX) * 1.5;
    marqueeStageRef.current.scrollLeft = scrollLeft - walk;
  };
  ...
  const handleTouchStart = (e) => {
    ...
    setIsDragging(true);
    setStartX(touch.pageX - marqueeStageRef.current.offsetLeft);
    setScrollLeft(marqueeStageRef.current.scrollLeft);
    setIsPaused(true);
  };
  ...
  const handleTouchMove = (e) => {
    ...
    const touch = e.touches[0];
    const x = touch.pageX - marqueeStageRef.current.offsetLeft;
    const walk = (x - startX) * 1.5;
    marqueeStageRef.current.scrollLeft = scrollLeft - walk;
  };
  ...
  const scrollMarquee = (direction) => {
    ...
    const currentScroll = marqueeStageRef.current.scrollLeft;
    const targetScroll = direction === 'left' 
      ? currentScroll - scrollAmount 
      : currentScroll + scrollAmount;
    
    marqueeStageRef.current.scrollTo({
      left: targetScroll,
      behavior: 'smooth'
    });
          ...
          <div className="prd-container">
            ...
            {featuredProducts.length >
              ...
              <div className="prd-featured">
                ...
                <div className="prd-marquee-wrapper">
                  
                  {!isMobile && featuredProducts.length > 3 && (
                    <button
                      className="prd-marquee-btn prd-marquee-btn-left"
                  ...
                  {!isMobile && featuredProducts.length > 3 && (
                    <button
                      className="prd-marquee-btn prd-marquee-btn-right"
                ...
                {isMobile && featuredProducts.length > 3 && (
                  <div className="prd-marquee-scroll-hint">
