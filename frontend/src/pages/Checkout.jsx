...
// // Remove /api only for uploaded files and images
...
//     id: "self_collection",
//     label:
//       "Self Collection (Rhein Main Region only)",
//     description:
//       "Pick up from our store in Rhein Main region",
//     value: "self_collection",
//   },
// ];
...
//                     {!documentLoading &&
//                       documentUrl && (
//                         <div className="checkout-document-link">
...
function Checkout() {
  ...
  // ===================================================
  // EXPECTED DELIVERY DATE FROM CART
  // ===================================================

  const getInitialExpectedDeliveryDate = () => {
    const routerDate =
      location?.state?.expectedDeliveryDate;

    if (
      typeof routerDate === "string" &&
      routerDate.trim()
    ) {
      return routerDate;
    }
    ...
    try {
      ...
      if (
        typeof savedDate === "string"
      ) {
        return savedDate;
      }
    } catch (error) {
      console.warn(
        "Unable to read expected delivery date:",
        error
      );
    }
  ...
  const [
    ...
    getInitialExpectedDeliveryDate
  );
  ...
  const handleSubmit =
    async (event) => {
      ...
      try {
        ...
        const cleanExpectedDeliveryDate =
          String(
            expectedDeliveryDate || ""
          ).trim();
            ...
            <aside className="checkout-sidebar">
              ...
              <div className="checkout-summary">
                ...
                {expectedDeliveryDate && (
                  ...
                  <div className="checkout-order-description checkout-expected-delivery">
