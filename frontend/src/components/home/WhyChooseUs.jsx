...
function WhyChooseUs() {
  ...
  const pillars = [
    {
      ...
      title: "Curated Excellence",
      description:
        "Every event and product undergoes rigorous vetting. From concerts to organic provisions, we deliver only the finest experiences and ingredients.",
    },
    {
      icon: "◈",
      title: "Trusted Partnerships",
      description:
        "Verified event organizers and certified organic farm partners across continents. Lab-tested products you can rely on, always.",
    },
    {
      icon: "◆",
      title: "End-to-End Quality",
      description:
        "From farm to table, concept to execution — we maintain uncompromising standards across every gathering and product we deliver.",
    },
    {
      icon: "★",
      title: "Exclusive Privileges",
      description:
        "Early access to sold-out experiences, limited edition organic drops, and member-only gatherings you won't find anywhere else.",
    },
  ];
  ...
  return (
    <section
      ref={sectionRef}
      className={`wc-compact ${isVisible ? "wc-visible" : ""}`}
    >
      {/* Background */}
      <div className="wc-bg-compact" aria-hidden="true">
        <div className="wc-glow-compact wc-glow-compact--teal" />
        <div className="wc-glow-compact wc-glow-compact--blue" />
        <div className="wc-grain-compact" />
      </div>

      <div className="wc-container-compact">
        {/* Header - Minimal */}
        <div className="wc-header-compact">
          <div className="wc-tag-compact">
            <span className="wc-tag-dot" />
            <span>Why Choose Us</span>
          </div>
          <h2 className="wc-title-compact">
            Heritage-driven, <span className="wc-title-highlight">future-focused</span>
          </h2>
          <p className="wc-subtitle-compact">
            A century-old legacy bridging deep-rooted Indian heritage with European innovation
          </p>
        </div>

        {/* Pillar Grid */}
        <div className="wc-grid-compact">
          {pillars.map((pillar, index) => (
            <div
              key={pillar.title}
              className={`wc-card-compact`}
              style={{ "--card-index": index }}
            >
              <div className="wc-card-icon">{pillar.icon}</div>
              <h3 className="wc-card-title-compact">{pillar.title}</h3>
              <p className="wc-card-description-compact">{pillar.description}</p>
            </div>
          ))}
        </div>

        {/* Heritage Strip */}
        <div className="wc-heritage-compact">
          <div className="wc-heritage-item">
            <span className="wc-heritage-number">100+</span>
            <span className="wc-heritage-label">Years of Heritage</span>
          </div>
          <div className="wc-heritage-divider" />
          <div className="wc-heritage-item">
            <span className="wc-heritage-number">🇩🇪</span>
            <span className="wc-heritage-label">German Precision</span>
          </div>
          <div className="wc-heritage-divider" />
          <div className="wc-heritage-item">
            <span className="wc-heritage-number">🇮🇳</span>
            <span className="wc-heritage-label">Indian Soul</span>
          </div>
          <div className="wc-heritage-divider" />
          <div className="wc-heritage-item">
            <span className="wc-heritage-number">✓</span>
            <span className="wc-heritage-label">Verified Quality</span>
          </div>
        </div>
      </div>
    </section>
